...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.ship = Ship(self)  # 传递当前AlienInvasion的实例,让Ship能够访问游戏资源
        ...
        # 加载图标图像
        icon = pygame.image.load("./img/alien_icon.png")
        # 设置窗口图标
