...
class Send_Mail():
    ...
    def __init__(self,report_file,sender='4792740@qq.com',receiver='4792740@qq.com',subject='自动化测试报告'):
        """
        该方法用来做初始的设置
        ...
        self.att["Content-Disposition"] = 'attachment; filename="test1_report.html"'
        self.msg.attach(self.att)

    def common_send_mail(self,smtpserver="smtp.qq.com"):
        """发送邮件的方法"""
        smtp = smtplib.SMTP_SSL(smtpserver)
        smtp.login(self.sender,'密码') #注意此密码不是qq登录密码
