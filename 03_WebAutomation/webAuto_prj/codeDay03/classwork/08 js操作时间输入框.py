...
"""
# http://172.16.20.203:8080/crm

from selenium import webdriver
from time import sleep

driver = webdriver.Chrome()
driver.get('http://172.16.20.203:8080/crm')
driver.maximize_window()
sleep(2)
driver.find_element_by_name('userNum').send_keys('admin')
driver.find_element_by_name('userPw').send_keys(123456)
driver.find_element_by_id('in1').submit()
...
sleep(2)
# 点击"客户信息”按纽
driver.find_element_by_partial_link_text('信息').click()
sleep(2)
# 再次切换frame--但要先退出当前frame
driver.switch_to.parent_frame()
frame2 = driver.find_element_by_xpath('/html/frameset/frameset/frame[2]')

driver.switch_to.frame(frame2)
# 点击“添加”按纽
driver.find_element_by_css_selector('input[type="button"][value="添加"]').click()
sleep(2)

# 在出生日期栏输入日期
# 输入姓名
driver.find_element_by_name('customerName').send_keys('小朋友')
sleep(1)
